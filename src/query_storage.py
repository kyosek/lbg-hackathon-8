...
logger.info("loading pretrained RAG model.")
RERANKER = RAGPretrainedModel.from_pretrained("colbert-ir/colbertv2.0")

logger.info("loading Auto parts.")
...
logger.info("Creating 'llm' object")
llm = HuggingFacePipeline(pipeline=READER_LLM)
logger.info("Creating 'eval_llm' object")
...
def main(query: str):
    i = 0
    logger.info("loading Chroma.")

    logger.info("calling 'retrieve_context'")
